...
<section class="pg-section-fit-content">
    <h2 class="center-txt">Some Pet Care Articles from our Partners</h2>
    <div class="task-set rss-feed rss-left">
    ...
    <div class="task-set rss-feed rss-right">
